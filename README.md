...
<p align="center">
  <img src="IMG_0334.png" width="180">
  <img src="IMG_0335.png" width="180">
</p>
...
$UNIQ is a **pure utility token** designed to power the UniQ application and incentivize learning.

| Allocation | Percentage | Purpose |
| :--- | :--- | :--- |
| **Learn-to-Earn Rewards** | 40% | Incentives for completing educational modules. |
| **Ecosystem Incentives** | 20% | Community engagement and growth. |
...
* **[span_7](start_span)User Growth:** Lowers the barrier to entry for new investors and developers[span_7](end_span).
* **[span_8](start_span)Risk Mitigation:** Provides the community with a clear view of which projects are delivering[span_8](end_span).
* **[span_9](start_span)Support Relief:** Reduces the burden on support channels by providing a self-service learning hub[span_9](end_span).
* **[span_10](start_span)Ecosystem Synergy:** UniQ acts as a "Force Multiplier" by promoting other dApps through dedicated modules[span_10](end_span).
...
- [ ] **[span_11](start_span)Phase 1 (Jan-Feb):** Launch of News, Market Feed, and Project Tracker (MVP)[span_11](end_span).
- [ ] **[span_12](start_span)Phase 2 (Mar-Apr):** Implementation of the L2E Engine and Reward logic[span_12](end_span).
- [ ] **[span_13](start_span)Phase 3 (May-Jun):** Non-custodial Wallet integration and Marketplace[span_13](end_span).
